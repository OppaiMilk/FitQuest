...
class CoachBookingDetails extends StatelessWidget {
  final Booking booking;
  final BookingParser _bookingParser;

  CoachBookingDetails({super.key, required this.booking})
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () {
                        print('user details screen');
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UserDetailsScreen(userId: booking.userId,),
                          ),
                        );
                      },
                    ),
